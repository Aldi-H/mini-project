    ...
    <div class="row">
      <div class="col">
        <div class="card mb-grid">
          <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#ModalUploadPhoto">+ Generate
            Kode Baru</button>
                    ...
                    <thead>
                      <tr role="row">
                        <th scope="col" class="sorting_asc" tabindex="0" aria-controls="DataTables_Table_0"
                          ...
                          aria-label=": activate to sort column descending" style="width: 88px;">
